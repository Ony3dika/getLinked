...
function Partners() {
  return (
    <div className='py-16 relative isolate container mx-auto px-10 lg:px-32'>
      <img
        src={pflare}
      ...
      <img
        src={starpu}
        className='absolute h-4 lg:h-7 lg:top-1/4 top-1/4 left-1/4'
        alt='purple star'
      />
      <img
        src={starw}
        className='absolute h-4 lg:h-7 lg:top-3/4 top-2/4 left-[70%]'
        alt='white star'
      />
      <img
        src={pflare}
