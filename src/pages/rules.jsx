    ...
    <div className='flex lg:flex-row flex-col py-10 container mx-auto px-10 lg:px-24 border-white/[18%] border-b-[1.5px]'>
      <section className='lg:basis-1/2 lg:order-1 overflow-x-clip order-2 flex relative isolate  items-center basis-full'>
        <img
          ...
          alt='purple-flare'
        />
        <img src={star} className="lg:h-6 h-4 absolute top-1/4 left-1/3" alt="star" />
        <img src={starw} className="absolute lg:left-auto left-1/3 lg:right-0 lg:h-7 h-4 -bottom-6 lg:bottom-1/3" alt="white-star" />
        <article>
